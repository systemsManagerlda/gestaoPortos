...
import { NoticiaDashboard } from "./NoticiasDashboard";
import { NoticiaList } from "../noticias/NoticiaList";
import { NoticiaForm } from "../noticias/NoticiaForm";
import { NoticiaDetail } from "../noticias/NoticiaDetail";
...
export default function NoticiasPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 text-gray-950">
